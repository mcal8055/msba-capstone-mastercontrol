...
> **[▶ Open the live interactive dashboard](https://mcal8055.github.io/msba-capstone-mastercontrol/dashboard.html)** to explore feature importance, shape functions, and the threshold-vs-cost trade-off with live controls. No install required — click through and drag the sliders.
...
- **Built an [interactive dashboard](https://mcal8055.github.io/msba-capstone-mastercontrol/dashboard.html)** (hosted on GitHub Pages) that makes the model's outputs explorable without requiring R. It lets a viewer drill into feature importance, cycle through shape functions, and drag sliders to see how the threshold and outreach cost change expected net value per 1,000 leads.
...
| File | Description |
|------|-------------|
| [`dashboard.html`](./dashboard.html) · **[Live link](https://mcal8055.github.io/msba-capstone-mastercontrol/dashboard.html)** | Interactive dashboard — feature importance, shape function explorer, threshold/cost trade-off, model comparison. Self-contained; renders via GitHub Pages. |
